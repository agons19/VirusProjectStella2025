...
tokenizer = AutoTokenizer.from_pretrained("/home/tuq33671/.cache/huggingface/hub/models--meta-llama--LlamaGuard-7b/snapshots/dfcfa3409b9994a4722d44e05f82e81ea73c5106")
model = AutoModelForCausalLM.from_pretrained("/home/tuq33671/.cache/huggingface/hub/models--meta-llama--LlamaGuard-7b/snapshots/dfcfa3409b9994a4722d44e05f82e81ea73c5106")
import csv
import re
...
with open("virus_numeric_answers7B.csv", "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerows(table_data)

print("✅ Numerical answers saved to 'virus_numeric_answers7B.csv'")
