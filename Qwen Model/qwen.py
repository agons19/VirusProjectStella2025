...
tokenizer = AutoTokenizer.from_pretrained("/home/tuq33671/.cache/huggingface/hub/models--Qwen--Qwen2.5-7B-Instruct/snapshots/a09a35458c702b33eeacc393d103063234e8bc28")
model = AutoModelForCausalLM.from_pretrained("/home/tuq33671/.cache/huggingface/hub/models--Qwen--Qwen2.5-7B-Instruct/snapshots/a09a35458c702b33eeacc393d103063234e8bc28")
import csv
import re
...
with open("qwen.csv", "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerows(table_data)

print("✅ Numerical answers saved to 'qwen.csv'")
